...
class CSSmin
{
	...
	protected $preserved_tokens;

	protected $memory_limit;

	protected $max_execution_time;

	protected $pcre_backtrack_limit;

	protected $pcre_recursion_limit;

	protected $raise_php_limits;

	/**
	 * If true, PHP settings will be raised if needed
	 *
	 * @param   bool|int  $raise_php_limits  Raise PHP Limits
	 */
	 ...
	 * @param   int|bool  $linebreak_pos  Linebreak position
	 *
	 * @return string
	 */
	...
	private function do_raise_php_limits()
	{
		$php_limits = array('memory_limit' => $this->memory_limit, 'max_execution_time' => $this->max_execution_time,
			'pcre.backtrack_limit' => $this->pcre_backtrack_limit, 'pcre.recursion_limit' => $this->pcre_recursion_limit);
	 ...
	 *
	 * @param   string    $css            CSS content
	 * @param   int|bool  $linebreak_pos  Linebeark position
	 *
	 * @return string
	 */
	...
	private function compress_hex_colors($css)
	{
		...
		$short_safe = array('#808080' => 'gray', '#008000' => 'green', '#800000' => 'maroon', '#000080' => 'navy', '#808000' => 'olive',
			'#800080' => 'purple', '#c0c0c0' => 'silver', '#008080' => 'teal', '#f00' => 'red');
	 ...
	 *
	 * @param   tring     $str   String
	 * @param   int       $from  From index
	 * @param   int|bool  $to    To index (optional)
	 *
	 * @return string
	 */
